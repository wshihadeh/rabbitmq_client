# -*- encoding: utf-8 -*-
# stub: simplecov 0.18.4 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.metadata = { "bug_tracker_uri" => "https://github.com/colszowka/simplecov/issues", "changelog_uri" => "https://github.com/colszowka/simplecov/blob/master/CHANGELOG.md", "documentation_uri" => "https://www.rubydoc.info/gems/simplecov/0.18.4", "mailing_list_uri" => "https://groups.google.com/forum/#!forum/simplecov", "source_code_uri" => "https://github.com/colszowka/simplecov/tree/v0.18.4" } if s.respond_to? :metadata=
